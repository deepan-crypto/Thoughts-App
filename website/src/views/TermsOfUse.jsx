  ...
  return (
    <div className="legal-page">
      <header className="legal-hero">
        ...
        <span className="legal-hero__badge">Terms of Use</span>
        <h1 className="legal-hero__title">Terms of Use</h1>
        <p className="legal-hero__meta">Last updated May 12, 2026</p>
      </header>
      ...
      <div className="legal-body">
        <aside className="legal-toc">
          ...
          <ul className="legal-toc__list" style={{ maxHeight: "70vh", overflowY: "auto", paddingRight: "0.5rem" }}>
            <li className="legal-toc__item"><a href="#term-1">1. OUR SERVICES</a></li>
            <li className="legal-toc__item"><a href="#term-2">2. INTELLECTUAL PROPERTY RIGHTS</a></li>
            <li className="legal-toc__item"><a href="#term-3">3. USER REPRESENTATIONS</a></li>
            <li className="legal-toc__item"><a href="#term-4">4. USER REGISTRATION</a></li>
            <li className="legal-toc__item"><a href="#term-5">5. PROHIBITED ACTIVITIES</a></li>
            <li className="legal-toc__item"><a href="#term-6">6. USER GENERATED CONTRIBUTIONS</a></li>
            <li className="legal-toc__item"><a href="#term-7">7. CONTRIBUTION LICENSE</a></li>
            <li className="legal-toc__item"><a href="#term-8">8. GUIDELINES FOR REVIEWS</a></li>
            <li className="legal-toc__item"><a href="#term-9">9. MOBILE APPLICATION LICENSE</a></li>
            <li className="legal-toc__item"><a href="#term-10">10. SERVICES MANAGEMENT</a></li>
            <li className="legal-toc__item"><a href="#term-11">11. PRIVACY POLICY</a></li>
            <li className="legal-toc__item"><a href="#term-12">12. COPYRIGHT INFRINGEMENTS</a></li>
            <li className="legal-toc__item"><a href="#term-13">13. TERM AND TERMINATION</a></li>
            <li className="legal-toc__item"><a href="#term-14">14. MODIFICATIONS AND INTERRUPTIONS</a></li>
            <li className="legal-toc__item"><a href="#term-15">15. GOVERNING LAW</a></li>
            <li className="legal-toc__item"><a href="#term-16">16. DISPUTE RESOLUTION</a></li>
            <li className="legal-toc__item"><a href="#term-17">17. CORRECTIONS</a></li>
            <li className="legal-toc__item"><a href="#term-18">18. DISCLAIMER</a></li>
            <li className="legal-toc__item"><a href="#term-19">19. LIMITATIONS OF LIABILITY</a></li>
            <li className="legal-toc__item"><a href="#term-20">20. INDEMNIFICATION</a></li>
            <li className="legal-toc__item"><a href="#term-21">21. USER DATA</a></li>
            <li className="legal-toc__item"><a href="#term-22">22. ELECTRONIC COMMUNICATIONS</a></li>
            <li className="legal-toc__item"><a href="#term-23">23. CALIFORNIA USERS</a></li>
            <li className="legal-toc__item"><a href="#term-24">24. MISCELLANEOUS</a></li>
            <li className="legal-toc__item"><a href="#term-25">25. CONTACT US</a></li>
          </ul>
        </aside>
        ...
        <article className="legal-article">
          <section style={{ marginBottom: "2rem" }}>
            ...
            <p>
              We are Thoughts, doing business as Thoughts ("Company," "we," "us," 
              "our"), a company registered in India at 26c/1a, Kamaraj Nagar, 3rd 
              Mile, Tuticorin, Tamil Nadu 628008.
            </p>
            <p>
              We operate the mobile application Thoughts (the "App"), as well as any 
              other related products and services that refer or link to these legal terms 
              (the "Legal Terms") (collectively, the "Services").
            </p>
            <p>
              A social platform where users can create polls and the community can vote 
              and engage with them.
            </p>
            <p>
              You can contact us by phone at +91 63807 75 229, email 
              at <a href="mailto:thoughtsapp.support@gmail.com">thoughtsapp.support@gmail.com</a>, or by mail to 26c/1a, Kamaraj Nagar, 
              3rd Mile, Tuticorin, Tamil Nadu 628008, India.
            </p>
            <p>
              These Legal Terms constitute a legally binding agreement made between 
              you, whether personally or on behalf of an entity ("you"), and Thoughts, 
          ...
          <section id="term-2">
            ...
            <p>
              ...
              your request to: <a href="mailto:thoughtsapp.support@gmail.com">thoughtsapp.support@gmail.com</a>. If we ever grant you the 
          ...
          <section id="term-9">
            <h2>9. MOBILE APPLICATION LICENSE</h2>
            <h3>Use License</h3>
            ...
            <ul>
              <li>(1) except as permitted by applicable law, decompile, reverse engineer, disassemble, attempt to derive the source code of, or decrypt the App;</li>
              <li>(2) make any modification, adaptation, improvement, enhancement, translation, or derivative work from the App;</li>
              <li>(3) violate any applicable laws, rules, or regulations in connection with your access or use of the App;</li>
              <li>(4) remove, alter, or obscure any proprietary notice (including any notice of copyright or trademark) posted by us or the licensors of the App;</li>
              <li>(5) use the App for any revenue-generating endeavor, commercial enterprise, or other purpose for which it is not designed or intended;</li>
              <li>(6) make the App available over a network or other environment permitting access or use by multiple devices or users at the same time;</li>
              <li>(7) use the App for creating a product, service, or software that is, directly or indirectly, competitive with or in any way a substitute for the App;</li>
              <li>(8) use the App to send automated queries to any website or to send any unsolicited commercial email; or</li>
              <li>(9) use any proprietary information or any of our interfaces or our other intellectual property in the design, development, manufacture, licensing, or distribution of any applications, accessories, or devices for use with the App.</li>
            </ul>
            ...
            <ul>
              <li>(1) the license granted to you for our App is limited to a non-transferable license to use the application on a device that utilizes the Apple iOS or Android operating systems, as applicable, and in accordance with the usage rules set forth in the applicable App Distributor’s terms of service;</li>
              ...
              <li>(3) in the event of any failure of the App to conform to any applicable warranty, you may notify the applicable App Distributor, and the App Distributor, in accordance with its terms and policies, may refund the purchase price, if any, paid for the App, and to the maximum extent permitted by applicable law, the App Distributor will have no other warranty obligation whatsoever with respect to the App;</li>
              <li>(4) you represent and warrant that (i) you are not located in a country that is subject to a US government embargo, or that has been designated by the US government as a "terrorist supporting" country and (ii) you are not listed on any US government list of prohibited or restricted parties;</li>
              <li>(5) you must comply with applicable third-party terms of agreement when using the App, e.g., if you have a VoIP application, then you must not be in violation of their wireless data service agreement when using the App; and</li>
          ...
          <section id="term-11">
            ...
            <p>
              ...
              Policy: <a href="https://thoughts.co.in/privacy-policy.html" target="_blank" rel="noreferrer">https://thoughts.co.in/privacy-policy.html</a>. By using the Services, 
              you agree to be bound by our Privacy Policy, which is incorporated into 
              these Legal Terms. Please be advised the Services are hosted in India. If 
              you access the Services from any other region of the world with laws or 
              other requirements governing personal data collection, use, or disclosure 
              that differ from applicable laws in India, then through your continued use 
              of the Services, you are transferring your data to India, and you expressly 
          ...
          <section id="term-15">
            ...
            <p>These Legal Terms shall be governed by and defined following the laws of India. Thoughts and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
          </section>
          ...
          <section id="term-16">
            ...
            <p>Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be three (3). The seat, or legal place, or arbitration shall be Tuticorin, India. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of India.</p>
            <h3>Restrictions</h3>
          ...
          <section id="term-18">
            <h2>18. DISCLAIMER</h2>
            <p>THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE SERVICES AND YOUR USE THEREOF, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE SERVICES' CONTENT OR THE CONTENT OF ANY WEBSITES OR MOBILE APPLICATIONS LINKED TO THE SERVICES AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY (1) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT AND MATERIALS, (2) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE SERVICES, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN, (4) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE SERVICES, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SERVICES BY ANY THIRD PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCRED AS A RESULT OF THE USE OF ANY CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SERVICES. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE SERVICES, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION FEATURED IN ANY BANNERS OR OTHER ADVERTISING, AND WE WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND ANY THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES. AS WITH THE PURCHASE OF A PRODUCT OR SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE.</p>
          </section>
